---
layout: post
title: "Secure Boot Setup on CachyOS (systemd-boot)"
date: 2026-02-20
permalink: /systemd_boot/
categories: [linux]
teaser: "Complete guide to enabling Secure Boot on CachyOS (Arch-based) using systemd-boot and sbctl."
---
