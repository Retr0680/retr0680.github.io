...
// dark mode
document.addEventListener("DOMContentLoaded",function(){var e=document.getElementById("theme-toggle"),t="dark-mode";if(!e)return;console.log("Dark mode toggle initialized"),"dark"===localStorage.getItem("theme")&&(document.documentElement.classList.add(t),e.textContent="☀️/🌙"),e.addEventListener("click",function(){console.log("Dark mode toggle clicked");var o=document.documentElement.classList.toggle(t);localStorage.setItem("theme",o?"dark":"light"),e.textContent=o?"☀️/🌙":"☀️/🌙"})});
